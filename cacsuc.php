...
<body>
    ...
    <!--SHOP ICON-->
    <a class="shopiconbtn" role="button" data-toggle="modal" data-target="#cart"><img class="fixed" src="images/aa.png" style="width: 70px; height: 70px;" alt="Cart"><span class="badge total-count">0</span></a>
    <!--SHOP MODAL-->
    ...
    <header class="jumbotron">
        <div class="container-fluid">    
                    ...
                    <nav class="navbar navbar-dark navbar-expand-sm navbarheader">
                        ...
                        <div class="collapse navbar-collapse" id="Navbar">                      
                            <ul class="navbar-nav offset-3">
                                <li class="nav-item offset-2 liheader"><a class="nav-link" href="index.php" style="color: #9dc5c3;"> Home</a></li>                   
                                <li class="nav-item offset-2 liheader"><a class="nav-link" href="index.php #about" style="color: #9dc5c3;"> About</a></li>                    
                                <li class="nav-item offset-2 active liheader"><a class="nav-link" href="shop.php"> Shop</a></li>                   
                                <li class="nav-item offset-2 liheader"><a class="nav-link" href="index.php #contact" style="color: #9dc5c3;"> Contact</a></li>           
                            </ul>                  
                        </div>
                    </nav>
                </div>
            ...
            <div class="row row-content ml-auto">
    ...
    <div class="container-fluid">
        <!--Left Content-->
        <div class="left col-12 col-md-3 row row-content">
            <!--Categories-->
            <div class="col-12">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="prodimage">
                                            <img src="images/suc3.jpg" alt="Ghost Plant" style="border: 5px solid #B39C4D; width: 300px; height: 300px;">
