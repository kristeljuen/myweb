            ...
            <div class="col-12">
                <aside class="sidebar-categorie">
                    ...
                    <ul class="navbar-nav" style="font-size: 17px;">
                        ...
                        <li class="nav-item active"><a class="nav-link sidebaractive" href="flower.php">Flowers<span class="right">(3)</span></a></li>
                    </ul><br>
                </aside>
            </div>
            <!--Top Products-->
    ...
    <div class="col-12"  style="display: inline-block; margin-top: 20px; right: 30px;">
        <nav class="float-sm-right" aria-label="Page navigation">
            <ul class="pagination justify-content-center">
                <li class=" page-item"><a class="page-link" href="cacsuc.php" tabindex="-1">&laquo;</a></li>
